...
<template>
    <div class=" w-full flex flex-col items-start space-y-2">
        ...
        <div class=" w-full flex flex-row items-center space-x-2 cursor-pointer relative" @click="show = !show">
            <div ref="input" class=" w-full p-3 h-[46px] bg-background rounded-xl text-[15px] text-primary font-normal font-montserrat outline-none placeholder-[#4F4F4F33] whitespace-nowrap">{{modelValue}}</div>
